      ...
      scopeRight(&audioProcessor.scopeFifoRight, 512, 256, 64, juce::Colours::white)
{
    ...
    createKnob("RandomSeed", "Seed", seedColour);
    createKnob("CycleDuration", "Cycle Dur.", glitchColour);
    createKnob("GlitchDurMean", "Dur Mean", glitchColour);
    createKnob("GlitchDurStdDev", "Dur StdDev", glitchColour);
    createKnob("GlitchProb", "Glitch Prob.", glitchColour);
    ...
    createKnob("CutLengthMean", "Mean", timingColour);
    createKnob("CutLengthStdDev", "StdDev", timingColour);
